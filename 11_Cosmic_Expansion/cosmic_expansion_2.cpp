...
void expandSpace(std::vector<std::vector<char>> &grid, std::vector<int> &rowsExpansionIndexes, std::vector<int> &colsExpansionIndexes){
...
void correctExpansion(std::vector<std::pair<int, int>> &galaxiesCoords, std::vector<int> &rowsExpansionIndexes, std::vector<int> &colsExpansionIndexes){
    ...
    for(auto &coord: galaxiesCoords){
        ...
        for(int rowIndex: rowsExpansionIndexes){
            ...
            if(coord.first > rowIndex)  numCorrections ++;
        }
        coord.first += numCorrections * expansionCorrection;
        ...
        coord.second +=  numCorrections * expansionCorrection;
    }
}
...
int main(){
    ...
    expandSpace(grid, rowsExpansionIndexes, colsExpansionIndexes);
